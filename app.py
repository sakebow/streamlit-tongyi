...
basic_page = st.Page("ui/basic.py", title = "ChatRender", icon = ":material/cloud:")
update_basic_page = st.Page("ui/update_basic.py", title = "ChatRenderCallbackHandler", icon = ":material/cloud:")
